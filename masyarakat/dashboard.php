<table class="responsive-table" border="2" style="width: 100%;">
	...
	<tr>
		<td style="padding: 20px;">
			<form method="POST" enctype="multipart/form-data">
				<textarea class="materialize-textarea col s12 m6" name="laporan" placeholder="Tulis Laporan"></textarea><br><br><br>
				<label>Gambar</label>
  ...
  <ul class="collapsible">
    <li>
      <div class="collapsible-header"><i class="material-icons">bug_report</i>Laporan</div>
      <div class="collapsible-body"><span>
      	
			<table border="3" class="responsive-table striped highlight">
			<h4 class="orange-text hide-on-med-and-down">Laporan Terkirim</h4>
				<tr>
					<td>No</td>
					<td>NIK</td>
					<td>Nama</td>
				...
				<?php 
					$no=1;
					$pengaduan = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN masyarakat ON pengaduan.nik=masyarakat.nik WHERE pengaduan.nik='".$_SESSION['data']['nik']."' AND pengaduan.status='belum diproses' OR pengaduan.status='proses' ORDER BY pengaduan.id_pengaduan DESC");
					...
					<tr>
						...
						<td>
							<a class="btn blue modal-trigger" href="#lap&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a> 
...
<!-- ditanggapi -->
        <div id="lap&id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
...
<!-- ditanggapi -->
    ...
    <li>
      <div class="collapsible-header"><i class="material-icons">check</i>Laporan Selesai</div>
      <div class="collapsible-body"><span>

			<table border="3" class="responsive-table striped highlight">
			<h4 class="orange-text hide-on-med-and-down">Laporan Selesai</h4>
				<tr>
					<td>No</td>
					<td>NIK</td>
					<td>Nama</td>
		...
		if($foto !=""){
		 	if(in_array($eks, $listeks)){
		 		if($size<=100000){
					...
					$query = mysqli_query($koneksi,"INSERT INTO pengaduan VALUES (NULL,'$tgl','$nik','".$_POST['laporan']."','$nama','belum diproses')");
			...
			$query = mysqli_query($koneksi,"INSERT INTO pengaduan VALUES (NULL,'$tgl','$nik','".$_POST['laporan']."','noImage.png','belum proses')");
			if($query){
